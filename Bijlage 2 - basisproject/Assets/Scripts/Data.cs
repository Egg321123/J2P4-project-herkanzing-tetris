...
{
    // Vooraf berekende rotatiematrix voor 90 graden rotatie (gebruikt bij het draaien van tetromino's)
    public static readonly float cos = Mathf.Cos(Mathf.PI / 2f);
    public static readonly float sin = Mathf.Sin(Mathf.PI / 2f);
    public static readonly float[] RotationMatrix = new float[] { cos, sin, -sin, cos };

    // Data van de cellen van elk tetromino in de standaardrotatie
    ...
    // Wall kick-data voor het I-blok
    ...
    // Wall kick-data voor alle andere blokken (J, L, O, S, T, Z)
    ...
    // Koppelt elk tetromino-type aan de juiste wall kick
